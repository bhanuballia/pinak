...
def explain_varga_chart(
    ...
    if _HAS_GEMINI and os.getenv("GEMINI_API_KEY"):
        try:
            ...
            explanation = _generate_template_explanation(d_number, varga_info, planet_analysis, style)
    else:
        explanation = _generate_template_explanation(d_number, varga_info, planet_analysis, style)
        ...
        if varga_data:
            try:
                ...
                if d_num in [1, 9, 10]:
                    ...
                    explanation = _generate_template_explanation(d_num, varga_info, planet_analysis, style)
