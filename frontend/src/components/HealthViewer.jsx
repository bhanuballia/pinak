                    ...
                    <section style={{ marginBottom: '80px' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '30px' }}>
                            ...
                            <div style={{ 
                                ...
                                <p style={{ fontSize: '10px', textTransform: 'uppercase', fontWeight: 900, letterSpacing: '4px', color: '#10b981', marginBottom: '15px' }}>Physical Vitality Index</p>
                                <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'baseline', gap: '10px', marginBottom: '10px' }}>
                                    <span style={{ fontSize: '72px', fontWeight: 900, color: 'white' }}>{personalData.score}</span>
                            ...
                            <div style={{ 
                                ...
                                <p style={{ fontSize: '10px', textTransform: 'uppercase', fontWeight: 900, letterSpacing: '4px', color: '#94a3b8', marginBottom: '25px' }}>Planetary Health Markers</p>
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                                    {personalData.notes?.map((n, i) => (
                                        <div key={i} style={{ display: 'flex', gap: '15px', alignItems: 'flex-start' }}>
                                            <span style={{ color: '#10b981', fontSize: '18px' }}>✦</span>
                                            <p style={{ fontSize: '16px', color: '#cbd5e1', margin: 0, fontStyle: 'italic', lineHeight: '1.5' }}>{n}</p>
                                        </div>
                                    ))}
                                </div>
                            </div>
                            ...
                            <div style={{ 
                                ...
                                <p style={{ fontSize: '10px', fontWeight: 900, textTransform: 'uppercase', letterSpacing: '2px', color: '#94a3b8', marginBottom: '25px' }}>Auspicious Wellness Remedies</p>
                                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '20px' }}>
                                    {personalData.remedies?.map((r, i) => (
                                        <div key={i} style={{ padding: '20px', borderRadius: '25px', background: 'rgba(16, 185, 129, 0.05)', border: '1px solid rgba(16, 185, 129, 0.1)' }}>
                                            <p style={{ fontSize: '14px', color: '#6ee7b7', margin: 0, fontStyle: 'italic' }}>{r}</p>
                                        </div>
                                    ))}
                                </div>
                            </div>
                        ...
                        {filteredInsights.map((item, idx) => (
                            <div key={idx} style={{ 
                                ...
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '25px' }}>
                                    <span style={{ padding: '6px 15px', borderRadius: '100px', background: 'rgba(16, 185, 129, 0.05)', fontSize: '10px', color: '#10b981', fontWeight: 900, textTransform: 'uppercase', letterSpacing: '2px', border: '1px solid rgba(16, 185, 129, 0.1)' }}>{item.category}</span>
