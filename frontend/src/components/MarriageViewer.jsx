...
export default function MarriageViewer() {
    ...
    return (
        <div style={{ minHeight: '100vh', backgroundColor: theme.bg, color: theme.text, fontFamily: 'serif', paddingBottom: '100px', position: 'relative' }}>
                ...
                <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '20px', flexWrap: 'wrap' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                        <div style={{
                            ...
                            boxShadow: '0 8px 20px rgba(136, 19, 55, 0.1)',
                            shrink: 0
                        }}>💑</div>
                        <div>
                            <h1 style={{ fontSize: `${30 * fontScale}px`, fontWeight: 900, color: theme.heading, margin: 0, fontStyle: 'italic', letterSpacing: '-1.5px' }}>Marriage & Relationship Guide</h1>
                            <p style={{ color: '#be123c', textTransform: 'uppercase', letterSpacing: '3px', fontSize: `${12 * fontScale}px`, fontWeight: 900, marginTop: '4px' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
                        ...
                        <div style={{
                            ...
                            <button onClick={decreaseFont} style={{ background: 'transparent', border: 'none', borderRight: '1px solid #fecdd3', padding: '6px 12px', color: '#881337', cursor: 'pointer', fontWeight: 'bold', fontSize: '13px' }}>A-</button>
                            <button onClick={resetFont} style={{ background: 'transparent', border: 'none', borderRight: '1px solid #fecdd3', padding: '6px 12px', color: '#881337', cursor: 'pointer', fontWeight: 'bold', fontSize: '13px' }}>Reset</button>
                            <button onClick={increaseFont} style={{ background: 'transparent', border: 'none', padding: '6px 12px', color: '#881337', cursor: 'pointer', fontWeight: 'bold', fontSize: '13px' }}>A+</button>
                        </div>
                        ...
                        <button
                            ...
                            style={{
                                padding: '12px 24px',
                                borderRadius: '100px',
                                background: showFullAnalysis ? '#881337' : 'linear-gradient(135deg, #e11d48 0%, #be123c 100%)',
                                color: '#ffffff',
                                border: 'none',
                        ...
                        >
                            {showFullAnalysis ? '📋 Show Diagnostic Overview' : '📜 View Vedic Marriage Analysis'}
                        </button>

                        {/* Topics Index Dropdown Button */}
                        {showFullAnalysis && (
                            <div style={{ position: 'relative' }}>
                                <button
                                    ...
                                    style={{
                                        ...
                                        cursor: 'pointer',
                                        transition: 'all 0.3s ease',
                                        boxShadow: '0 6px 20px rgba(159, 18, 57, 0.25)',
                                        display: 'flex',
                                        alignItems: 'center',
                                        gap: '6px'
                                    }}
                                >
                                    <span>📌 CLICK ON TOPICS TO KNOW MORE ABOUT MARRIAGE </span>
                                    <span>{isTopicDropdownOpen ? '▲' : '▼'}</span>
                                </button>
                                ...
                                {isTopicDropdownOpen && (
                                    <div style={{
                                        ...
                                        boxShadow: '0 20px 50px rgba(136, 19, 55, 0.25)',
                                        padding: '12px 0',
                                        zIndex: 2000,
                                        maxHeight: '420px',
                                        overflowY: 'auto'
                                    }}>
                                        <div style={{ padding: '8px 20px 12px', borderBottom: '1px solid #ffe4e6' }}>
                                            <p style={{ margin: 0, fontSize: '16px', fontWeight: 900, textTransform: 'uppercase', color: '#be123c', letterSpacing: '2px' }}>
                                                Quick Jump to Section
                                            </p>
                                        </div>
                                        {[
                                            { id: 'section-timing', label: '✨ Marriage Age & Timing Diagnostic' },
                                            { id: 'section-d9', label: '🌸 Navamsha (D9) Soul Destiny' },
                                            { id: 'section-nakshatras', label: '🌸 Favorable Marriage Nakshatras' },
                                            { id: 'section-love-arranged', label: '💘 Love vs. Arranged Marriage' },
                                            { id: 'section-fidelity', label: '🔒 Marital Fidelity & Secrecy' },
                                            { id: 'section-strengths', label: '🛡️ Major Strengths & Challenges' },
                                            { id: 'section-partner', label: '💘 Ideal Life Partner Profile' },
                                            { id: 'section-divorce', label: '⚖️ Legal Separation & Vichheda' },
                                            { id: 'section-remarriage', label: '💞 Remarriage & Dwi-Vivaha' },
                                            { id: 'section-bhava-lords', label: '📜 7th Lord Placement Scroll' },
                                            { id: 'section-remedies', label: '💎 Remedial Remedies & Gems' },
                                        ].map((topic, tIdx) => (
                                            <button
                                                key={tIdx}
                                                onClick={() => {
                                                ...
                                                style={{
                                                    ...
                                                    borderBottom: tIdx < 10 ? '1px solid #fff1f2' : 'none'
                                                }}
            ...
            <div style={{ maxWidth: '1200px', margin: showFullAnalysis ? '20px auto' : '60px auto', padding: '0 40px' }}>
                {error && (
                ...
                {/* Detailed Vedic Marriage Analysis view toggle */}
                {showFullAnalysis ? (
                    <section style={{ marginBottom: '80px' }}>
                        <div style={{ background: '#ffffff', borderRadius: '40px', border: `1px solid ${theme.borderColor}`, overflow: 'hidden', boxShadow: '0 20px 40px rgba(136, 19, 55, 0.08)' }}>
                            <MarriageAnalysis />
                        </div>
                    </section>
                ) : (
                            ...
                            <section style={{ marginBottom: '80px' }}>
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '30px' }}>
                                    ...
                                    <div style={{
                                        ...
                                        <p style={{ fontSize: `${13 * fontScale}px`, textTransform: 'uppercase', fontWeight: 900, letterSpacing: '3px', color: '#be123c', marginBottom: '8px' }}>Predicted Marriage Window</p>
                                        <p style={{ fontSize: `${28 * fontScale}px`, fontWeight: 900, color: '#881337', margin: '4px 0' }}>{personalData.age}</p>
                                        <p style={{ fontSize: `${15 * fontScale}px`, fontWeight: 700, color: '#be123c', fontStyle: 'italic', margin: 0 }}>{personalData.age_en}</p>
                                    </div>
                                    ...
                                    <div style={{
                                        ...
                                        <p style={{ fontSize: `${13 * fontScale}px`, textTransform: 'uppercase', fontWeight: 900, letterSpacing: '3px', color: '#475569', marginBottom: '8px' }}>Harmony Index</p>
                                        <p style={{ fontSize: `${28 * fontScale}px`, fontWeight: 900, color: '#881337', margin: '4px 0' }}>{personalData.harmony_index}</p>
                                        <p style={{ fontSize: `${15 * fontScale}px`, fontWeight: 900, textTransform: 'uppercase', letterSpacing: '3px', color: '#b45309', margin: 0 }}>{personalData.label}</p>
                                    </div>
