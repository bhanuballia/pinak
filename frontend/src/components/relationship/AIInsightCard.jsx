...
const AIInsightCard = ({ report }) => {
  ...
  return (
    <div className="bg-indigo-900/40 p-6 rounded-[2rem] border border-indigo-500/30 backdrop-blur-xl relative overflow-hidden flex flex-col justify-between">
      <div className="absolute bottom-0 left-0 w-48 h-48 bg-indigo-500/10 blur-3xl rounded-full -ml-24 -mb-24"></div>
      
      <div>
        <div className="flex justify-between items-start mb-6">
          <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-indigo-300">AI Forecasting</h4>
          <div className={`px-3 py-1 rounded-full text-[9px] font-black tracking-widest ${
            isLowRisk ? 'bg-emerald-500/20 text-emerald-400 border border-emerald-500/30' : 
