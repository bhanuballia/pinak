...
const SynastryOverlay = ({ report }) => {
  ...
  return (
    <div className="bg-fuchsia-900/20 p-6 rounded-[2rem] border border-fuchsia-500/20 backdrop-blur-md relative overflow-hidden flex flex-col justify-between">
      ...
      <div className="flex items-center space-x-3 mb-6 relative z-10">
        ...
        <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-fuchsia-300">
          Synastry Engine
        </h4>
      </div>
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center w-full">
        <div className="flex items-end justify-center mb-4">
          ...
          <div className="text-xs text-slate-400 mb-1 ml-1 uppercase tracking-widest">/100</div>
        </div>
      ...
      <button 
        ...
        className="mt-4 w-full py-2 bg-fuchsia-500/10 hover:bg-fuchsia-500/20 transition border border-fuchsia-500/30 rounded-lg text-xs font-bold uppercase tracking-widest text-fuchsia-400">
