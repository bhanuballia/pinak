...
export const NAVAMSA_PLANET_DESCRIPTIONS = {
  Sun: {
  ...
  Rahu: {
    ...
    description: "The combination of Rahu and Navamsa chart rewards you with fulfillment of desires, and manifest dreams and imagination of your spouse. Rahu will make you wealthy after marriage and it will also reveal the honesty and commitment of your partner in the relationship. Rahu affliction in D9 chart will cause health concerns and create diseases that may not be easily diagnosed, and inherited health problems.",
    icon: "🌑",
    color: "slate"
  },
  Ketu: {
    title: "Ketu in Navamsa Chart",
    description: "Ketu in the Navamsa chart gives you a personality that helps you maintain a strong relationship on personal and professional front. Ketu in D9 Chart also brings surprises in terms of wealth and abundance. A well-placed Ketu will give you a supportive spouse for your career and professional growth. In addition, Ketu influences your life based on its placement in 12 different houses in D9 chart.",
    icon: "🚩",
    color: "brown"
  }
};
